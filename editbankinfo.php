        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="editbankinfo.php">Update Bank Info</a>
...
<div class="container-fluid">
    ...
    <h2 class="mt-4">UPDATE BANK INFO</h2>
    <br>
    <?php echo $msg; ?>
    <br>
...
<div class="row">
    ...
    <input type="text" class="form-control" name="bank_name" placeholder="Bank Name." value ="<?php $sql= "SELECT * FROM bankinfo WHERE email='{$_SESSION['SESSION_EMAIL']}'";
        $result = $db->query($sql);
...
<div class="row">
    <div class="form-group col-md-12">
    <input type="text" class="form-control" name="account_name" placeholder="Account Name. It must match with the name you are currently using to apply and also no BVN issues." value ="<?php $sql= "SELECT * FROM bankinfo WHERE email='{$_SESSION['SESSION_EMAIL']}'";
        $result = $db->query($sql);
        if ($result->rowCount() > 0) {
            $row = $result->fetch();
...
<div class="row">
    <div class="form-group col-md-12">
        <input type="text" class="form-control" maxlength="10" name="account_no" placeholder="Account No" value ="<?php $sql= "SELECT * FROM bankinfo WHERE email='{$_SESSION['SESSION_EMAIL']}'";
        $result = $db->query($sql);
        if ($result->rowCount() > 0) {
            $row = $result->fetch();
            echo $row['account_no'];
