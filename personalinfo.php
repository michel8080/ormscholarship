...
if (isset($_REQUEST['save'])) {
	...
	echo "</div>";
    $msg = "<div class='alert alert-success'>Personal Info Saved Successfully!. Click the following link to Add Educational Info. <b><a href=http://localhost/hyprepscholarship/educationalinfo.php>Add Your Education Info!</a></b></div>";
 }
}
...
<div class="row">
    ...
    <div class="form-group col-md-4">
        <input type="text" class="form-control" name="Phone" maxlength="11" placeholder="Phone" required>
    </div>

    <div class="form-group col-md-4">
        <input type="email" class="form-control" name="Email" placeholder="Email" value ="<?php $sql= "SELECT * FROM users WHERE email='{$_SESSION['SESSION_EMAIL']}'";
        $result = $db->query($sql);
...
<div class="row">
    ...
    <div class="form-group col-md-4">
        <input type="text" class="form-control" name="Community" placeholder="Community" required>
    </div>
...
<div class="row">
    ...
    <div class="form-group col-md-4">
        <input type="text" class="form-control" name="FatherLGACommunity" placeholder="Father LGA/Community" required>
    </div>
</div>
<!-- End of A Row-->
<br>
<div class="row">
    <div class="form-group col-md-3">
        <input type="text" class="form-control" name="MotherLGACommunity" placeholder="Mother LGA/Community" required>
    </div>

    <div class="form-group col-md-3">
        <input type="text" class="form-control" name="NOK" placeholder="Next of Kin Name" required>
    </div>

    <div class="form-group col-md-3">
        <input type="text" class="form-control" name="NOKPhone" maxlength="11" placeholder="Next of Kin Phone" required>
    </div>

    <div class="form-group col-md-3">
        <input type="email" class="form-control" name="NOKEmail" placeholder="Next of Kin Email" required>
    </div>
</div>
<!-- End of A Row-->
<br>
